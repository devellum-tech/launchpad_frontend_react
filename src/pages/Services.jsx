    ...
    return (
        <Box sx={{ backgroundColor: '#fafafa', pb: 8, width: '100%' }}>
            ...
            >
                ...
                >
                    We deliver transparent, timely, and high-quality IT solutions that drive growth,
            ...
            <Box sx={{ maxWidth: '1000px', mx: 'auto', mt: 8, px: 2, textAlign: 'center' }}>
                <Typography variant="h4" fontWeight="bold" gutterBottom>
                    Our Mission & Vision
                </Typography>
                <Divider sx={{ width: 60, mx: 'auto', mb: 3, borderColor: '#1f1c2c' }} />
                <Typography variant="body1" sx={{ color: '#555', mb: 2 }}>
                    Our mission is to create innovative, scalable, and impactful digital solutions
                    that help businesses thrive in the modern era.
                </Typography>
                <Typography variant="body1" sx={{ color: '#555' }}>
                    With a vision to become a trusted technology partner worldwide, we combine
                    technical expertise with transparent processes to deliver excellence.
                </Typography>
            </Box>
            ...
            <Box sx={{ maxWidth: '1280px', mx: 'auto', mt: 8, px: 2 }}>
                ...
                <Typography variant="body1" textAlign="center" mb={6} sx={{ color: '#555' }}>
                    Comprehensive solutions designed to meet your business needs with speed,
